...
/**
 * <p>Java class for COCT_MT841500UV.Person complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT841500UV.Person">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asEmployment" type="{urn:hl7-org:v3}COCT_MT841500UV.Employment" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="asEntityInContainer" type="{urn:hl7-org:v3}COCT_MT841500UV.EntityInContainer" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="birthplace" type="{urn:hl7-org:v3}COCT_MT841500UV.Birthplace" minOccurs="0"/>
 *         &lt;element name="placeOfDeath" type="{urn:hl7-org:v3}COCT_MT841500UV.PlaceOfDeath" minOccurs="0"/>
 ...
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT841500UV.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT841500UV.Person", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "quantity",
...
public class COCTMT841500UVPerson {
    ...
    protected List<COCTMT841500UVEmployment> asEmployment;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVQualifiedEntity> asQualifiedEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVIdentifier> asIdentifier;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVEntityInContainer> asEntityInContainer;
    @XmlElement(nillable = true)
    ...
    protected JAXBElement<COCTMT841500UVBirthplace> birthplace;
    @XmlElementRef(name = "placeOfDeath", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT841500UVPlaceOfDeath> placeOfDeath;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVLanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVEmployment }
     * 
     * 
     */
    public List<COCTMT841500UVEmployment> getAsEmployment() {
        if (asEmployment == null) {
            asEmployment = new ArrayList<COCTMT841500UVEmployment>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVEntityInContainer }
     * 
     * 
     */
    public List<COCTMT841500UVEntityInContainer> getAsEntityInContainer() {
        if (asEntityInContainer == null) {
            asEntityInContainer = new ArrayList<COCTMT841500UVEntityInContainer>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT841500UVBirthplace }{@code >}
     *     
     */
    public JAXBElement<COCTMT841500UVBirthplace> getBirthplace() {
        return birthplace;
    }
     ...
     *     
     */
    public void setBirthplace(JAXBElement<COCTMT841500UVBirthplace> value) {
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT841500UVPlaceOfDeath }{@code >}
     *     
     */
    public JAXBElement<COCTMT841500UVPlaceOfDeath> getPlaceOfDeath() {
        return placeOfDeath;
    }
     ...
     *     
     */
    public void setPlaceOfDeath(JAXBElement<COCTMT841500UVPlaceOfDeath> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVLanguageCommunication }
     * 
     * 
     */
    public List<COCTMT841500UVLanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT841500UVLanguageCommunication>();
        }
