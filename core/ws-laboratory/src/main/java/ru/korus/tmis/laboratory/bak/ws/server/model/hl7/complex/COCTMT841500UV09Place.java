...
/**
 * <p>Java class for COCT_MT841500UV09.Place complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT841500UV09.Place">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asTerritorialAuthority" type="{urn:hl7-org:v3}COCT_MT841500UV09.TerritorialAuthority" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asPartOfWhole" type="{urn:hl7-org:v3}COCT_MT841500UV09.PartOfWhole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLocatedPlacePartOf" type="{urn:hl7-org:v3}COCT_MT841500UV09.LocatedPlacePartOf" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="locatedPlaceHasParts" type="{urn:hl7-org:v3}COCT_MT841500UV09.LocatedPlaceHasParts" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "COCT_MT841500UV09.Place", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class COCTMT841500UV09Place {
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UV09TerritorialAuthority> asTerritorialAuthority;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UV09PartOfWhole> asPartOfWhole;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UV09LocatedPlacePartOf> asLocatedPlacePartOf;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UV09LocatedPlaceHasParts> locatedPlaceHasParts;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UV09TerritorialAuthority }
     * 
     * 
     */
    public List<COCTMT841500UV09TerritorialAuthority> getAsTerritorialAuthority() {
        if (asTerritorialAuthority == null) {
            asTerritorialAuthority = new ArrayList<COCTMT841500UV09TerritorialAuthority>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UV09LocatedPlacePartOf }
     * 
     * 
     */
    public List<COCTMT841500UV09LocatedPlacePartOf> getAsLocatedPlacePartOf() {
        if (asLocatedPlacePartOf == null) {
            asLocatedPlacePartOf = new ArrayList<COCTMT841500UV09LocatedPlacePartOf>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UV09LocatedPlaceHasParts }
     * 
     * 
     */
    public List<COCTMT841500UV09LocatedPlaceHasParts> getLocatedPlaceHasParts() {
        if (locatedPlaceHasParts == null) {
            locatedPlaceHasParts = new ArrayList<COCTMT841500UV09LocatedPlaceHasParts>();
        }
