...
/**
 * <p>Java class for POLB_MT004000UV01.ObservationEvent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="POLB_MT004000UV01.ObservationEvent">
 *   &lt;complexContent>
 ...
 *         &lt;element name="consumable1" type="{urn:hl7-org:v3}POLB_MT004000UV01.Consumable" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="consumable2" type="{urn:hl7-org:v3}POLB_MT004000UV01.Consumable2" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="derivedFrom1" type="{urn:hl7-org:v3}POLB_MT004000UV01.DerivedFrom1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="derivedFrom2" type="{urn:hl7-org:v3}POLB_MT004000UV01.DerivedFrom2" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="referenceRange" type="{urn:hl7-org:v3}POLB_MT004000UV01.ReferenceRange" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "POLB_MT004000UV01.ObservationEvent", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POLBMT004000UV01ObservationEvent {
    ...
    @XmlElement(nillable = true)
    protected List<POLBMT004000UV01Consumable> consumable1;
    @XmlElement(nillable = true)
    protected List<POLBMT004000UV01Consumable2> consumable2;
    ...
    @XmlElement(nillable = true)
    protected List<POLBMT004000UV01DerivedFrom1> derivedFrom1;
    @XmlElement(nillable = true)
    protected List<POLBMT004000UV01DerivedFrom2> derivedFrom2;
    @XmlElement(nillable = true)
    protected List<POLBMT004000UV01ReferenceRange> referenceRange;
    @XmlElement(nillable = true)
     ...
     * 
     */
    public List<POLBMT004000UV01Consumable> getConsumable1() {
        if (consumable1 == null) {
            consumable1 = new ArrayList<POLBMT004000UV01Consumable>();
        }
     ...
     * 
     */
    public List<POLBMT004000UV01Consumable2> getConsumable2() {
        if (consumable2 == null) {
            consumable2 = new ArrayList<POLBMT004000UV01Consumable2>();
        }
    ...
    /**
     * Gets the value of the derivedFrom1 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the derivedFrom1 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDerivedFrom1().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POLBMT004000UV01DerivedFrom1 }
     * 
     * 
     */
    public List<POLBMT004000UV01DerivedFrom1> getDerivedFrom1() {
        if (derivedFrom1 == null) {
            derivedFrom1 = new ArrayList<POLBMT004000UV01DerivedFrom1>();
        }
        return this.derivedFrom1;
    }

    /**
     * Gets the value of the derivedFrom2 property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the derivedFrom2 property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDerivedFrom2().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POLBMT004000UV01DerivedFrom2 }
     * 
     * 
     */
    public List<POLBMT004000UV01DerivedFrom2> getDerivedFrom2() {
        if (derivedFrom2 == null) {
            derivedFrom2 = new ArrayList<POLBMT004000UV01DerivedFrom2>();
        }
        return this.derivedFrom2;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link POLBMT004000UV01ReferenceRange }
     * 
     * 
     */
    public List<POLBMT004000UV01ReferenceRange> getReferenceRange() {
        if (referenceRange == null) {
            referenceRange = new ArrayList<POLBMT004000UV01ReferenceRange>();
        }
