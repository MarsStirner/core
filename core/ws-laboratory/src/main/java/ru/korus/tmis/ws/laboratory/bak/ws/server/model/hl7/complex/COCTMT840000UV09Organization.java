...
/**
 * <p>Java class for COCT_MT840000UV09.Organization complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT840000UV09.Organization">
 *   &lt;complexContent>
 ...
 *         &lt;element name="jurisdiction" type="{urn:hl7-org:v3}COCT_MT840000UV09.Jurisdiction" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="hasProductEntity" type="{urn:hl7-org:v3}COCT_MT840000UV09.HasProductEntity" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "COCT_MT840000UV09.Organization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class COCTMT840000UV09Organization {
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT840000UV09Jurisdiction> jurisdiction;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT840000UV09HasProductEntity> hasProductEntity;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT840000UV09Jurisdiction }
     * 
     * 
     */
    public List<COCTMT840000UV09Jurisdiction> getJurisdiction() {
        if (jurisdiction == null) {
            jurisdiction = new ArrayList<COCTMT840000UV09Jurisdiction>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT840000UV09HasProductEntity }
     * 
     * 
     */
    public List<COCTMT840000UV09HasProductEntity> getHasProductEntity() {
        if (hasProductEntity == null) {
            hasProductEntity = new ArrayList<COCTMT840000UV09HasProductEntity>();
        }
