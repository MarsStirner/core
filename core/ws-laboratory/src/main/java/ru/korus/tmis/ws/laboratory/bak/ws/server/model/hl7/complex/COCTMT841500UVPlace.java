...
/**
 * <p>Java class for COCT_MT841500UV.Place complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT841500UV.Place">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asTerritorialAuthority" type="{urn:hl7-org:v3}COCT_MT841500UV.TerritorialAuthority" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asPartOfWhole" type="{urn:hl7-org:v3}COCT_MT841500UV.PartOfWhole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLocatedPlacePartOf" type="{urn:hl7-org:v3}COCT_MT841500UV.LocatedPlacePartOf" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="locatedPlaceHasParts" type="{urn:hl7-org:v3}COCT_MT841500UV.LocatedPlaceHasParts" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "COCT_MT841500UV.Place", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class COCTMT841500UVPlace {
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVTerritorialAuthority> asTerritorialAuthority;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVPartOfWhole> asPartOfWhole;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVLocatedPlacePartOf> asLocatedPlacePartOf;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVLocatedPlaceHasParts> locatedPlaceHasParts;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVTerritorialAuthority }
     * 
     * 
     */
    public List<COCTMT841500UVTerritorialAuthority> getAsTerritorialAuthority() {
        if (asTerritorialAuthority == null) {
            asTerritorialAuthority = new ArrayList<COCTMT841500UVTerritorialAuthority>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVLocatedPlacePartOf }
     * 
     * 
     */
    public List<COCTMT841500UVLocatedPlacePartOf> getAsLocatedPlacePartOf() {
        if (asLocatedPlacePartOf == null) {
            asLocatedPlacePartOf = new ArrayList<COCTMT841500UVLocatedPlacePartOf>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVLocatedPlaceHasParts }
     * 
     * 
     */
    public List<COCTMT841500UVLocatedPlaceHasParts> getLocatedPlaceHasParts() {
        if (locatedPlaceHasParts == null) {
            locatedPlaceHasParts = new ArrayList<COCTMT841500UVLocatedPlaceHasParts>();
        }
