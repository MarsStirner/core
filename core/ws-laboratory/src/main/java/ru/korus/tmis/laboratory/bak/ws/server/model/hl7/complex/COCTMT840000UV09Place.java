...
/**
 * <p>Java class for COCT_MT840000UV09.Place complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT840000UV09.Place">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asTerritorialAuthority" type="{urn:hl7-org:v3}COCT_MT840000UV09.TerritorialAuthority" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asPartOfWhole" type="{urn:hl7-org:v3}COCT_MT840000UV09.PartOfWhole" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLocatedPlacePartOf" type="{urn:hl7-org:v3}COCT_MT840000UV09.LocatedPlacePartOf" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="locatedPlaceHasParts" type="{urn:hl7-org:v3}COCT_MT840000UV09.LocatedPlaceHasParts" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "COCT_MT840000UV09.Place", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class COCTMT840000UV09Place {
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT840000UV09TerritorialAuthority> asTerritorialAuthority;
    @XmlElement(nillable = true)
    protected List<COCTMT840000UV09PartOfWhole> asPartOfWhole;
    @XmlElement(nillable = true)
    protected List<COCTMT840000UV09LocatedPlacePartOf> asLocatedPlacePartOf;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT840000UV09LocatedPlaceHasParts> locatedPlaceHasParts;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT840000UV09TerritorialAuthority }
     * 
     * 
     */
    public List<COCTMT840000UV09TerritorialAuthority> getAsTerritorialAuthority() {
        if (asTerritorialAuthority == null) {
            asTerritorialAuthority = new ArrayList<COCTMT840000UV09TerritorialAuthority>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT840000UV09LocatedPlacePartOf }
     * 
     * 
     */
    public List<COCTMT840000UV09LocatedPlacePartOf> getAsLocatedPlacePartOf() {
        if (asLocatedPlacePartOf == null) {
            asLocatedPlacePartOf = new ArrayList<COCTMT840000UV09LocatedPlacePartOf>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT840000UV09LocatedPlaceHasParts }
     * 
     * 
     */
    public List<COCTMT840000UV09LocatedPlaceHasParts> getLocatedPlaceHasParts() {
        if (locatedPlaceHasParts == null) {
            locatedPlaceHasParts = new ArrayList<COCTMT840000UV09LocatedPlaceHasParts>();
        }
