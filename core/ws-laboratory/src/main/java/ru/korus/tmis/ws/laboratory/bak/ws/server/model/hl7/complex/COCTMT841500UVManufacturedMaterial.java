...
/**
 * <p>Java class for COCT_MT841500UV.ManufacturedMaterial complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT841500UV.ManufacturedMaterial">
 *   &lt;complexContent>
 ...
 *         &lt;element name="asIngredient" type="{urn:hl7-org:v3}COCT_MT841500UV.Ingredient" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="asProductEntity" type="{urn:hl7-org:v3}COCT_MT841500UV.ProductEntity" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="containedEntity" type="{urn:hl7-org:v3}COCT_MT841500UV.ContainedEntity" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="part" type="{urn:hl7-org:v3}COCT_MT841500UV.Part" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="hasIngredients" type="{urn:hl7-org:v3}COCT_MT841500UV.HasIngredients" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "COCT_MT841500UV.ManufacturedMaterial", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTMT841500UVManufacturedMaterial {
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVIngredient> asIngredient;
    @XmlElement(nillable = true)
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVProductEntity> asProductEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVContactParty> contactParty;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVRelatedEntity> relatedEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVContainedEntity> containedEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVPart> part;
    @XmlElement(nillable = true)
    protected List<COCTMT841500UVHasIngredients> hasIngredients;
    @XmlElement(nillable = true)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVIngredient }
     * 
     * 
     */
    public List<COCTMT841500UVIngredient> getAsIngredient() {
        if (asIngredient == null) {
            asIngredient = new ArrayList<COCTMT841500UVIngredient>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVProductEntity }
     * 
     * 
     */
    public List<COCTMT841500UVProductEntity> getAsProductEntity() {
        if (asProductEntity == null) {
            asProductEntity = new ArrayList<COCTMT841500UVProductEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVContainedEntity }
     * 
     * 
     */
    public List<COCTMT841500UVContainedEntity> getContainedEntity() {
        if (containedEntity == null) {
            containedEntity = new ArrayList<COCTMT841500UVContainedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT841500UVHasIngredients }
     * 
     * 
     */
    public List<COCTMT841500UVHasIngredients> getHasIngredients() {
        if (hasIngredients == null) {
            hasIngredients = new ArrayList<COCTMT841500UVHasIngredients>();
        }
