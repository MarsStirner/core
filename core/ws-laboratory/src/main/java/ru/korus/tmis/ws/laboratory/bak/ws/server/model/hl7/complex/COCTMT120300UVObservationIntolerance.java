...
/**
 * <p>Java class for COCT_MT120300UV.ObservationIntolerance complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT120300UV.ObservationIntolerance">
 *   &lt;complexContent>
 ...
 *         &lt;element name="performer" type="{urn:hl7-org:v3}COCT_MT120300UV.Performer1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="author" type="{urn:hl7-org:v3}COCT_MT120300UV.Author" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="dataEnterer" type="{urn:hl7-org:v3}COCT_MT120300UV.DataEnterer" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="definition" type="{urn:hl7-org:v3}COCT_MT120300UV.Definition" minOccurs="0"/>
 *         &lt;element name="causeOf" type="{urn:hl7-org:v3}COCT_MT120300UV.CauseOf" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="component" type="{urn:hl7-org:v3}COCT_MT120300UV.Component22" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT120300UV.ObservationIntolerance", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class COCTMT120300UVObservationIntolerance {
    ...
    protected List<COCTMT120300UVPerformer1> performer;
    @XmlElement(nillable = true)
    protected List<COCTMT120300UVAuthor> author;
    @XmlElement(nillable = true)
    protected List<COCTMT120300UVDataEnterer> dataEnterer;
    @XmlElementRef(name = "definition", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT120300UVDefinition> definition;
    @XmlElement(nillable = true)
    protected List<COCTMT120300UVCauseOf> causeOf;
    @XmlElementRef(name = "component", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT120300UVComponent22> component;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120300UVPerformer1 }
     * 
     * 
     */
    public List<COCTMT120300UVPerformer1> getPerformer() {
        if (performer == null) {
            performer = new ArrayList<COCTMT120300UVPerformer1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120300UVAuthor }
     * 
     * 
     */
    public List<COCTMT120300UVAuthor> getAuthor() {
        if (author == null) {
            author = new ArrayList<COCTMT120300UVAuthor>();
        }
        return this.author;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120300UVDataEnterer }
     * 
     * 
     */
    public List<COCTMT120300UVDataEnterer> getDataEnterer() {
        if (dataEnterer == null) {
            dataEnterer = new ArrayList<COCTMT120300UVDataEnterer>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT120300UVDefinition }{@code >}
     *     
     */
    public JAXBElement<COCTMT120300UVDefinition> getDefinition() {
        return definition;
    }
     ...
     *     
     */
    public void setDefinition(JAXBElement<COCTMT120300UVDefinition> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120300UVCauseOf }
     * 
     * 
     */
    public List<COCTMT120300UVCauseOf> getCauseOf() {
        if (causeOf == null) {
            causeOf = new ArrayList<COCTMT120300UVCauseOf>();
        }
        return this.causeOf;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT120300UVComponent22 }{@code >}
     *     
     */
    public JAXBElement<COCTMT120300UVComponent22> getComponent() {
        return component;
    }
     ...
     *     
     */
    public void setComponent(JAXBElement<COCTMT120300UVComponent22> value) {
