 ...
 * 2016-04-14T19:58:19.681+04:00
 * Generated source version: 3.1.6
 * 
 */
@WebServiceClient(name = "QueryAnalysisService", 
                  wsdlLocation = "file:lis-innova_singleWsdl.xml",
...
public class QueryAnalysisService extends Service {
    ...
    public final static QName BasicHttpBindingIqueryAnalysis = new QName("ru.novolabs.Integration.FTMIS", "BasicHttpBinding_IqueryAnalysis");
    static {
        URL url = null;
        try {
            url = new URL("file:lis-innova_singleWsdl.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(QueryAnalysisService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:lis-innova_singleWsdl.xml");
        }
        WSDL_LOCATION = url;
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IqueryAnalysis")
    public IqueryAnalysis getBasicHttpBindingIqueryAnalysis() {
        return super.getPort(BasicHttpBindingIqueryAnalysis, IqueryAnalysis.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpBinding_IqueryAnalysis")
    public IqueryAnalysis getBasicHttpBindingIqueryAnalysis(WebServiceFeature... features) {
        return super.getPort(BasicHttpBindingIqueryAnalysis, IqueryAnalysis.class, features);
    }
