/**
 * IAcrossIntf_FNKCbindingStub.java
 *
...
public class IAcrossIntf_FNKCbindingStub extends org.apache.axis.client.Stub implements IAcrossIntf_FNKC {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "PatientInfo"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.korusconsulting.ru", "PatientInfo"), PatientInfo.class, false, false);
    ...
    public IAcrossIntf_FNKCbindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public IAcrossIntf_FNKCbindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public IAcrossIntf_FNKCbindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public int queryAnalysis(PatientInfo patientInfo, DiagnosticRequestInfo diagnosticRequestInfo, BiomaterialInfo biomaterialInfo, OrderInfo orderInfo) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://www.korusconsulting.ru#queryAnalysis");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.korusconsulting.ru", "queryAnalysis"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {patientInfo, diagnosticRequestInfo, biomaterialInfo, orderInfo});
