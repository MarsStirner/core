 ...
 *       &lt;choice>
 *         &lt;element name="th" type="{urn:hl7-org:v3}StrucDoc.Th" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="td" type="{urn:hl7-org:v3}StrucDoc.Td" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/choice>
...
public class StrucDocTr {
    ...
    protected List<StrucDocTh> th;
    protected List<StrucDocTd> td;
     ...
     * 
     */
    public List<StrucDocTh> getTh() {
        if (th == null) {
            th = new ArrayList<StrucDocTh>();
        }
        return this.th;
    }
     ...
     * 
     */
    public List<StrucDocTd> getTd() {
        if (td == null) {
            td = new ArrayList<StrucDocTd>();
        }
        return this.td;
    }
