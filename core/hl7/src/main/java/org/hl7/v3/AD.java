 ...
 *       &lt;choice>
 *         &lt;element name="delimiter" type="{urn:hl7-org:v3}adxp.delimiter" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="country" type="{urn:hl7-org:v3}adxp.country" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="state" type="{urn:hl7-org:v3}adxp.state" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="county" type="{urn:hl7-org:v3}adxp.county" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="city" type="{urn:hl7-org:v3}adxp.city" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="postalCode" type="{urn:hl7-org:v3}adxp.postalCode" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="streetAddressLine" type="{urn:hl7-org:v3}adxp.streetAddressLine" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="houseNumber" type="{urn:hl7-org:v3}adxp.houseNumber" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="houseNumberNumeric" type="{urn:hl7-org:v3}adxp.houseNumberNumeric" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="direction" type="{urn:hl7-org:v3}adxp.direction" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="streetName" type="{urn:hl7-org:v3}adxp.streetName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="streetNameBase" type="{urn:hl7-org:v3}adxp.streetNameBase" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="streetNameType" type="{urn:hl7-org:v3}adxp.streetNameType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="additionalLocator" type="{urn:hl7-org:v3}adxp.additionalLocator" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="unitID" type="{urn:hl7-org:v3}adxp.unitID" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="unitType" type="{urn:hl7-org:v3}adxp.unitType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="careOf" type="{urn:hl7-org:v3}adxp.careOf" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="censusTract" type="{urn:hl7-org:v3}adxp.censusTract" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deliveryAddressLine" type="{urn:hl7-org:v3}adxp.deliveryAddressLine" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deliveryInstallationType" type="{urn:hl7-org:v3}adxp.deliveryInstallationType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deliveryInstallationArea" type="{urn:hl7-org:v3}adxp.deliveryInstallationArea" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deliveryInstallationQualifier" type="{urn:hl7-org:v3}adxp.deliveryInstallationQualifier" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deliveryMode" type="{urn:hl7-org:v3}adxp.deliveryMode" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deliveryModeIdentifier" type="{urn:hl7-org:v3}adxp.deliveryModeIdentifier" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="buildingNumberSuffix" type="{urn:hl7-org:v3}adxp.buildingNumberSuffix" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="postBox" type="{urn:hl7-org:v3}adxp.postBox" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="precinct" type="{urn:hl7-org:v3}adxp.precinct" maxOccurs="unbounded" minOccurs="0"/>
