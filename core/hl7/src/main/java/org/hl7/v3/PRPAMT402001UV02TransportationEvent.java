...
/**
 * <p>Java class for PRPA_MT402001UV02.TransportationEvent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT402001UV02.TransportationEvent">
 *   &lt;complexContent>
 ...
 *         &lt;element name="performer" type="{urn:hl7-org:v3}PRPA_MT402001UV02.Performer2" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="escort" type="{urn:hl7-org:v3}PRPA_MT402001UV02.Escort1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="location" type="{urn:hl7-org:v3}PRPA_MT402001UV02.Location4" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT402001UV02.TransportationEvent", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT402001UV02TransportationEvent {
    ...
    protected List<PRPAMT402001UV02Performer2> performer;
    @XmlElement(nillable = true)
    protected List<PRPAMT402001UV02Escort1> escort;
    @XmlElement(nillable = true)
    protected List<PRPAMT402001UV02Location4> location;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402001UV02Performer2 }
     * 
     * 
     */
    public List<PRPAMT402001UV02Performer2> getPerformer() {
        if (performer == null) {
            performer = new ArrayList<PRPAMT402001UV02Performer2>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402001UV02Escort1 }
     * 
     * 
     */
    public List<PRPAMT402001UV02Escort1> getEscort() {
        if (escort == null) {
            escort = new ArrayList<PRPAMT402001UV02Escort1>();
        }
        return this.escort;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402001UV02Location4 }
     * 
     * 
     */
    public List<PRPAMT402001UV02Location4> getLocation() {
        if (location == null) {
            location = new ArrayList<PRPAMT402001UV02Location4>();
        }
