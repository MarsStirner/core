...
/**
 * <p>Java class for PRPA_MT402002UV02.TransportationProcess complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT402002UV02.TransportationProcess">
 *   &lt;complexContent>
 ...
 *         &lt;element name="performer" type="{urn:hl7-org:v3}PRPA_MT402002UV02.Performer1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="escort" type="{urn:hl7-org:v3}PRPA_MT402002UV02.Escort2" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="location" type="{urn:hl7-org:v3}PRPA_MT402002UV02.Location3" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT402002UV02.TransportationProcess", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT402002UV02TransportationProcess {
    ...
    protected List<PRPAMT402002UV02Performer1> performer;
    @XmlElement(nillable = true)
    protected List<PRPAMT402002UV02Escort2> escort;
    @XmlElement(nillable = true)
    protected List<PRPAMT402002UV02Location3> location;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402002UV02Performer1 }
     * 
     * 
     */
    public List<PRPAMT402002UV02Performer1> getPerformer() {
        if (performer == null) {
            performer = new ArrayList<PRPAMT402002UV02Performer1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402002UV02Escort2 }
     * 
     * 
     */
    public List<PRPAMT402002UV02Escort2> getEscort() {
        if (escort == null) {
            escort = new ArrayList<PRPAMT402002UV02Escort2>();
        }
        return this.escort;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402002UV02Location3 }
     * 
     * 
     */
    public List<PRPAMT402002UV02Location3> getLocation() {
        if (location == null) {
            location = new ArrayList<PRPAMT402002UV02Location3>();
        }
