...
/**
 * <p>Java class for PRPA_MT402001UV02.ServiceDeliveryLocation complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PRPA_MT402001UV02.ServiceDeliveryLocation">
 *   &lt;complexContent>
 ...
 *         &lt;element name="serviceProviderOrganization" type="{urn:hl7-org:v3}COCT_MT150001UV01.Organization" minOccurs="0"/>
 *         &lt;element name="locationOf" type="{urn:hl7-org:v3}PRPA_MT402001UV02.Location2" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "PRPA_MT402001UV02.ServiceDeliveryLocation", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class PRPAMT402001UV02ServiceDeliveryLocation {
    ...
    protected JAXBElement<COCTMT150001UV01Organization> serviceProviderOrganization;
    @XmlElement(nillable = true)
    protected List<PRPAMT402001UV02Location2> locationOf;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT150001UV01Organization }{@code >}
     *     
     */
    public JAXBElement<COCTMT150001UV01Organization> getServiceProviderOrganization() {
     ...
     *     
     */
    public void setServiceProviderOrganization(JAXBElement<COCTMT150001UV01Organization> value) {
        this.serviceProviderOrganization = value;
    }

    /**
     * Gets the value of the locationOf property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the locationOf property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLocationOf().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PRPAMT402001UV02Location2 }
     * 
     * 
     */
    public List<PRPAMT402001UV02Location2> getLocationOf() {
        if (locationOf == null) {
            locationOf = new ArrayList<PRPAMT402001UV02Location2>();
        }
