...
import misexchange.PRPAIN402002UV02;
import misexchange.ProcessHL7V3Message;
import org.hl7.v3.*;
...
//            PRPAIN402002UV02MCCIMT000100UV01Message hl7V3Message = factory.createPRPAIN402002UV02MCCIMT000100UV01Message();
            ...
            final Request msg = factory.createPRPAIN402002UV02();


            final PRPAIN402002UV022 prpain402002UV02 = new PRPAIN402002UV022();
            ...
            final PRPAMT402002UV02InpatientEncounterEvent event = new PRPAMT402002UV02InpatientEncounterEvent();
...
//            patient.setPatientPerson(patientPerson);
            ...
            final PRPAMT402002UV02Location1 uv02Location1 = new PRPAMT402002UV02Location1();
            ...
            ((PRPAIN402002UV02)msg).setMessage(prpain402002UV02);
...
//            marshaller.setProperty(Marshaller.JAXB_ENCODING, "windows-1251");
           ...
           marshaller.marshal(msg, System.out);
            ...
            final MCCIIN000002UV01 mcciin000002UV01 = misExchange.getMISExchangeSoap().processHL7V3Message(msg);
            System.out.println("send " + mcciin000002UV01);
            demarshalling(mcciin000002UV01);
