 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F007Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F007")
public class F007 {

    @XmlElement(nillable = true)
    protected List<F007Type> rec;
     ...
     * 
     */
    public List<F007Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F007Type>();
        }
        return this.rec;
    }
