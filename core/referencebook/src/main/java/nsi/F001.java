 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F001Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F001")
public class F001 {

    @XmlElement(nillable = true)
    protected List<F001Type> rec;
     ...
     * 
     */
    public List<F001Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F001Type>();
        }
        return this.rec;
    }
