 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F009Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F009")
public class F009 {

    @XmlElement(nillable = true)
    protected List<F009Type> rec;
     ...
     * 
     */
    public List<F009Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F009Type>();
        }
        return this.rec;
    }
