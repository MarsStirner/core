 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}KladrType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Kladr {
     ...
     * 
     */
    public List<KladrType> getRec() {
        if (rec == null) {
            rec = new ArrayList<KladrType>();
        }
        return this.rec;
    }
