 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}R002Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "R002")
public class R002 {

    @XmlElement(nillable = true)
    protected List<R002Type> rec;
     ...
     * 
     */
    public List<R002Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<R002Type>();
        }
        return this.rec;
    }
