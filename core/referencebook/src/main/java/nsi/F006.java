 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F006Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F006")
public class F006 {

    @XmlElement(nillable = true)
    protected List<F006Type> rec;
     ...
     * 
     */
    public List<F006Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F006Type>();
        }
        return this.rec;
    }
