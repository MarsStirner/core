 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}O002Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "O002")
public class O002 {

    @XmlElement(nillable = true)
    protected List<O002Type> rec;
     ...
     * 
     */
    public List<O002Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<O002Type>();
        }
        return this.rec;
    }
