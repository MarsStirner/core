 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F012Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F012")
public class F012 {

    @XmlElement(nillable = true)
    protected List<F012Type> rec;
     ...
     * 
     */
    public List<F012Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F012Type>();
        }
        return this.rec;
    }
