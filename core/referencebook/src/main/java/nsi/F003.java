 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F003Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F003")
public class F003 {

    @XmlElement(nillable = true)
    protected List<F003Type> rec;
     ...
     * 
     */
    public List<F003Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F003Type>();
        }
        return this.rec;
    }
