 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}KladrStreetType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "KladrStreet")
public class KladrStreet {

    @XmlElement(nillable = true)
    protected List<KladrStreetType> rec;
     ...
     * 
     */
    public List<KladrStreetType> getRec() {
        if (rec == null) {
            rec = new ArrayList<KladrStreetType>();
        }
        return this.rec;
    }
