 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}O003Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "O003")
public class O003 {

    @XmlElement(nillable = true)
    protected List<O003Type> rec;
     ...
     * 
     */
    public List<O003Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<O003Type>();
        }
        return this.rec;
    }
