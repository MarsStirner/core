 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}R001Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "R001")
public class R001 {

    @XmlElement(nillable = true)
    protected List<R001Type> rec;
     ...
     * 
     */
    public List<R001Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<R001Type>();
        }
        return this.rec;
    }
