 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}V010Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "V010")
public class V010 {

    @XmlElement(nillable = true)
    protected List<V010Type> rec;
     ...
     * 
     */
    public List<V010Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<V010Type>();
        }
        return this.rec;
    }
