 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}R004Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "R004")
public class R004 {

    @XmlElement(nillable = true)
    protected List<R004Type> rec;
     ...
     * 
     */
    public List<R004Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<R004Type>();
        }
        return this.rec;
    }
