 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}V006Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "V006")
public class V006 {

    @XmlElement(nillable = true)
    protected List<V006Type> rec;
     ...
     * 
     */
    public List<V006Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<V006Type>();
        }
        return this.rec;
    }
