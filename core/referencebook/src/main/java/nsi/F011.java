 ...
 *       &lt;sequence>
 *         &lt;element name="rec" type="{urn:nsi}F011Type" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "F011")
public class F011 {

    @XmlElement(nillable = true)
    protected List<F011Type> rec;
     ...
     * 
     */
    public List<F011Type> getRec() {
        if (rec == null) {
            rec = new ArrayList<F011Type>();
        }
        return this.rec;
    }
