...
public class Communications {
  ...
  public interface Iface {
     ...
     * @return номер версии
     */
    public int getVersion() throws org.apache.thrift.TException;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<OrgStructure>(_list72.size);
                  for (int _i73 = 0; _i73 < _list72.size; ++_i73)
                  {
                    OrgStructure _elem74; // required
                    _elem74 = new OrgStructure();
                    _elem74.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getOrgStructures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (OrgStructure _iter75 : struct.success)
            {
              _iter75.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (OrgStructure _iter76 : struct.success)
            {
              _iter76.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<OrgStructure>(_list77.size);
            for (int _i78 = 0; _i78 < _list77.size; ++_i78)
            {
              OrgStructure _elem79; // required
              _elem79 = new OrgStructure();
              _elem79.read(iprot);
    ...
    private static class getAllOrgStructures_resultStandardScheme extends StandardScheme<getAllOrgStructures_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<OrgStructure>(_list80.size);
                  for (int _i81 = 0; _i81 < _list80.size; ++_i81)
                  {
                    OrgStructure _elem82; // required
                    _elem82 = new OrgStructure();
                    _elem82.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllOrgStructures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (OrgStructure _iter83 : struct.success)
            {
              _iter83.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getAllOrgStructures_resultTupleScheme extends TupleScheme<getAllOrgStructures_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllOrgStructures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (OrgStructure _iter84 : struct.success)
            {
              _iter84.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<OrgStructure>(_list85.size);
            for (int _i86 = 0; _i86 < _list85.size; ++_i86)
            {
              OrgStructure _elem87; // required
              _elem87 = new OrgStructure();
              _elem87.read(iprot);
    ...
    private static class getAddresses_resultStandardScheme extends StandardScheme<getAddresses_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Address>(_list88.size);
                  for (int _i89 = 0; _i89 < _list88.size; ++_i89)
                  {
                    Address _elem90; // required
                    _elem90 = new Address();
                    _elem90.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAddresses_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Address _iter91 : struct.success)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class getAddresses_resultTupleScheme extends TupleScheme<getAddresses_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAddresses_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Address _iter92 : struct.success)
            {
              _iter92.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Address>(_list93.size);
            for (int _i94 = 0; _i94 < _list93.size; ++_i94)
            {
              Address _elem95; // required
              _elem95 = new Address();
              _elem95.read(iprot);
    ...
    private static class getPersonnel_resultStandardScheme extends StandardScheme<getPersonnel_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Person>(_list104.size);
                  for (int _i105 = 0; _i105 < _list104.size; ++_i105)
                  {
                    Person _elem106; // required
                    _elem106 = new Person();
                    _elem106.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPersonnel_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Person _iter107 : struct.success)
            {
    ...
    private static class getPersonnel_resultTupleScheme extends TupleScheme<getPersonnel_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPersonnel_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Person _iter108 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Person>(_list109.size);
            for (int _i110 = 0; _i110 < _list109.size; ++_i110)
            {
              Person _elem111; // required
              _elem111 = new Person();
              _elem111.read(iprot);
    ...
    private static class getTicketsAvailability_resultStandardScheme extends StandardScheme<getTicketsAvailability_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ExtendedTicketsAvailability>(_list112.size);
                  for (int _i113 = 0; _i113 < _list112.size; ++_i113)
                  {
                    ExtendedTicketsAvailability _elem114; // required
                    _elem114 = new ExtendedTicketsAvailability();
                    _elem114.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getTicketsAvailability_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ExtendedTicketsAvailability _iter115 : struct.success)
            {
    ...
    private static class getTicketsAvailability_resultTupleScheme extends TupleScheme<getTicketsAvailability_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getTicketsAvailability_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ExtendedTicketsAvailability _iter116 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ExtendedTicketsAvailability>(_list117.size);
            for (int _i118 = 0; _i118 < _list117.size; ++_i118)
            {
              ExtendedTicketsAvailability _elem119; // required
              _elem119 = new ExtendedTicketsAvailability();
              _elem119.read(iprot);
    ...
    private static class findPatients_resultStandardScheme extends StandardScheme<findPatients_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Patient>(_list120.size);
                  for (int _i121 = 0; _i121 < _list120.size; ++_i121)
                  {
                    Patient _elem122; // required
                    _elem122 = new Patient();
                    _elem122.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findPatients_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Patient _iter123 : struct.success)
            {
    ...
    private static class findPatients_resultTupleScheme extends TupleScheme<findPatients_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, findPatients_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Patient _iter124 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Patient>(_list125.size);
            for (int _i126 = 0; _i126 < _list125.size; ++_i126)
            {
              Patient _elem127; // required
              _elem127 = new Patient();
              _elem127.read(iprot);
    ...
    private static class checkForNewQueueCoupons_resultStandardScheme extends StandardScheme<checkForNewQueueCoupons_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<QueueCoupon>(_list128.size);
                  for (int _i129 = 0; _i129 < _list128.size; ++_i129)
                  {
                    QueueCoupon _elem130; // required
                    _elem130 = new QueueCoupon();
                    _elem130.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkForNewQueueCoupons_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (QueueCoupon _iter131 : struct.success)
            {
    ...
    private static class checkForNewQueueCoupons_resultTupleScheme extends TupleScheme<checkForNewQueueCoupons_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, checkForNewQueueCoupons_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (QueueCoupon _iter132 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<QueueCoupon>(_list133.size);
            for (int _i134 = 0; _i134 < _list133.size; ++_i134)
            {
              QueueCoupon _elem135; // required
              _elem135 = new QueueCoupon();
              _elem135.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.patientIds = new ArrayList<Integer>(_list136.size);
                  for (int _i137 = 0; _i137 < _list136.size; ++_i137)
                  {
                    int _elem138; // required
                    _elem138 = iprot.readI32();
                    struct.patientIds.add(_elem138);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientInfo_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.patientIds != null) {
          oprot.writeFieldBegin(PATIENT_IDS_FIELD_DESC);
          {
            ...
            for (int _iter139 : struct.patientIds)
            {
        ...
        if (struct.isSetPatientIds()) {
          {
            ...
            for (int _iter140 : struct.patientIds)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.patientIds = new ArrayList<Integer>(_list141.size);
            for (int _i142 = 0; _i142 < _list141.size; ++_i142)
            {
              int _elem143; // required
              _elem143 = iprot.readI32();
              struct.patientIds.add(_elem143);
            }
          }
          struct.setPatientIdsIsSet(true);
        }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.success = new HashMap<Integer,Patient>(2*_map144.size);
                  for (int _i145 = 0; _i145 < _map144.size; ++_i145)
                  {
                    int _key146; // required
                    Patient _val147; // required
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientInfo_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, Patient> _iter148 : struct.success.entrySet())
            {
    ...
    private static class getPatientInfo_resultTupleScheme extends TupleScheme<getPatientInfo_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPatientInfo_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Map.Entry<Integer, Patient> _iter149 : struct.success.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new HashMap<Integer,Patient>(2*_map150.size);
            for (int _i151 = 0; _i151 < _map150.size; ++_i151)
            {
              int _key152; // required
              Patient _val153; // required
    ...
    private static class getPatientContacts_resultStandardScheme extends StandardScheme<getPatientContacts_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Contact>(_list154.size);
                  for (int _i155 = 0; _i155 < _list154.size; ++_i155)
                  {
                    Contact _elem156; // required
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Contact _iter157 : struct.success)
            {
    ...
    private static class getPatientContacts_resultTupleScheme extends TupleScheme<getPatientContacts_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPatientContacts_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Contact _iter158 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Contact>(_list159.size);
            for (int _i160 = 0; _i160 < _list159.size; ++_i160)
            {
              Contact _elem161; // required
              _elem161 = new Contact();
              _elem161.read(iprot);
    ...
    private static class getPatientOrgStructures_resultStandardScheme extends StandardScheme<getPatientOrgStructures_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<OrgStructuresProperties>(_list162.size);
                  for (int _i163 = 0; _i163 < _list162.size; ++_i163)
                  {
                    OrgStructuresProperties _elem164; // required
                    _elem164 = new OrgStructuresProperties();
                    _elem164.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientOrgStructures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (OrgStructuresProperties _iter165 : struct.success)
            {
    ...
    private static class getPatientOrgStructures_resultTupleScheme extends TupleScheme<getPatientOrgStructures_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPatientOrgStructures_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (OrgStructuresProperties _iter166 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<OrgStructuresProperties>(_list167.size);
            for (int _i168 = 0; _i168 < _list167.size; ++_i168)
            {
              OrgStructuresProperties _elem169; // required
              _elem169 = new OrgStructuresProperties();
              _elem169.read(iprot);
    ...
    private static class getPatientQueue_resultStandardScheme extends StandardScheme<getPatientQueue_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Queue>(_list170.size);
                  for (int _i171 = 0; _i171 < _list170.size; ++_i171)
                  {
                    Queue _elem172; // required
                    _elem172 = new Queue();
                    _elem172.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPatientQueue_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Queue _iter173 : struct.success)
            {
    ...
    private static class getPatientQueue_resultTupleScheme extends TupleScheme<getPatientQueue_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getPatientQueue_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Queue _iter174 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Queue>(_list175.size);
            for (int _i176 = 0; _i176 < _list175.size; ++_i176)
            {
              Queue _elem177; // required
              _elem177 = new Queue();
              _elem177.read(iprot);
    ...
    private static class getSpecialities_resultStandardScheme extends StandardScheme<getSpecialities_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Speciality>(_list178.size);
                  for (int _i179 = 0; _i179 < _list178.size; ++_i179)
                  {
                    Speciality _elem180; // required
                    _elem180 = new Speciality();
                    _elem180.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getSpecialities_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Speciality _iter181 : struct.success)
            {
    ...
    private static class getSpecialities_resultTupleScheme extends TupleScheme<getSpecialities_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getSpecialities_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Speciality _iter182 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Speciality>(_list183.size);
            for (int _i184 = 0; _i184 < _list183.size; ++_i184)
            {
              Speciality _elem185; // required
              _elem185 = new Speciality();
              _elem185.read(iprot);
