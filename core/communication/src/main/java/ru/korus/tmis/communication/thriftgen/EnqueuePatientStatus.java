...
public class EnqueuePatientStatus implements org.apache.thrift.TBase<EnqueuePatientStatus, EnqueuePatientStatus._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new EnqueuePatientStatusStandardSchemeFactory());
    schemes.put(TupleScheme.class, new EnqueuePatientStatusTupleSchemeFactory());
  }
  ...
  private _Fields optionals[] = {_Fields.MESSAGE,_Fields.INDEX,_Fields.QUEUE_ID};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(EnqueuePatientStatus.class, metaDataMap);
  }

  public EnqueuePatientStatus() {
  }
   ...
   */
  public EnqueuePatientStatus(EnqueuePatientStatus other) {
  ...
  public EnqueuePatientStatus deepCopy() {
    return new EnqueuePatientStatus(this);
  }
  ...
  public EnqueuePatientStatus setSuccess(boolean success) {
    this.success = success;
    setSuccessIsSet(true);
    return this;
  }
  ...
  public EnqueuePatientStatus setMessage(String message) {
  ...
  public EnqueuePatientStatus setIndex(int index) {
    this.index = index;
    setIndexIsSet(true);
    return this;
  }
  ...
  public EnqueuePatientStatus setQueueId(int queueId) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof EnqueuePatientStatus)
      return this.equals((EnqueuePatientStatus)that);
    return false;
  }

  public boolean equals(EnqueuePatientStatus that) {
    if (that == null)
      return false;
  ...
  public int compareTo(EnqueuePatientStatus other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    EnqueuePatientStatus typedOther = (EnqueuePatientStatus)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("EnqueuePatientStatus(");
    boolean first = true;
  ...
  private static class EnqueuePatientStatusStandardSchemeFactory implements SchemeFactory {
    public EnqueuePatientStatusStandardScheme getScheme() {
      return new EnqueuePatientStatusStandardScheme();
    }
  }

  private static class EnqueuePatientStatusStandardScheme extends StandardScheme<EnqueuePatientStatus> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, EnqueuePatientStatus struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EnqueuePatientStatus struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class EnqueuePatientStatusTupleSchemeFactory implements SchemeFactory {
    public EnqueuePatientStatusTupleScheme getScheme() {
      return new EnqueuePatientStatusTupleScheme();
    }
  }

  private static class EnqueuePatientStatusTupleScheme extends TupleScheme<EnqueuePatientStatus> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, EnqueuePatientStatus struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, EnqueuePatientStatus struct) throws org.apache.thrift.TException {
