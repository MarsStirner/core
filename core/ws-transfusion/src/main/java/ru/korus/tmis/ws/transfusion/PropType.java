...
public enum PropType {
    ...
    CHANGE_VOLUME("trfuProcedureChangeVolume", APValueDouble.class, "объем афереза – Изменения (параметры процедуры)"),
    ...
    VOLUME_PROC_RES("trfuProcedureVolume", APValueDouble.class, "объем эритроцитарной массы"),
    ...
    HT("trfuProcedureHt", APValueDouble.class, "гематокрит эритроцитарной массы"),
    SALINE_VOLUME("trfuProcedureSalineVolume", APValueDouble.class, "объем добавленного физ. раствора"),
