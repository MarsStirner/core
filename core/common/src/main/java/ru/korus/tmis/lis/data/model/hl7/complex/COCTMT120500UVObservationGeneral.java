...
/**
 * <p>Java class for COCT_MT120500UV.ObservationGeneral complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT120500UV.ObservationGeneral">
 *   &lt;complexContent>
 ...
 *         &lt;element name="dataEnterer" type="{urn:hl7-org:v3}COCT_MT120500UV.DataEnterer" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="definition" type="{urn:hl7-org:v3}COCT_MT120500UV.Definition" minOccurs="0"/>
 *         &lt;element name="referenceRange" type="{urn:hl7-org:v3}COCT_MT120500UV.ReferenceRange2" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT120500UV.ObservationGeneral", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
    ...
    implements Serializable
{
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT120500UVAuthor> author;
    @XmlElement(nillable = true)
    protected List<COCTMT120500UVDataEnterer> dataEnterer;
    @XmlElementRef(name = "definition", namespace = "urn:hl7-org:v3", type = JAXBElement.class, required = false)
    protected JAXBElement<COCTMT120500UVDefinition> definition;
    @XmlElement(nillable = true)
    protected List<COCTMT120500UVReferenceRange2> referenceRange;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120500UVPerformer1 }
     * 
     * 
     */
    public List<COCTMT120500UVPerformer1> getPerformer() {
        if (performer == null) {
            performer = new ArrayList<COCTMT120500UVPerformer1>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120500UVAuthor }
     * 
     * 
     */
    public List<COCTMT120500UVAuthor> getAuthor() {
        if (author == null) {
            author = new ArrayList<COCTMT120500UVAuthor>();
        }
        return this.author;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120500UVDataEnterer }
     * 
     * 
     */
    public List<COCTMT120500UVDataEnterer> getDataEnterer() {
        if (dataEnterer == null) {
            dataEnterer = new ArrayList<COCTMT120500UVDataEnterer>();
        }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link COCTMT120500UVDefinition }{@code >}
     *     
     */
    public JAXBElement<COCTMT120500UVDefinition> getDefinition() {
        return definition;
    }
     ...
     *     
     */
    public void setDefinition(JAXBElement<COCTMT120500UVDefinition> value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT120500UVReferenceRange2 }
     * 
     * 
     */
    public List<COCTMT120500UVReferenceRange2> getReferenceRange() {
        if (referenceRange == null) {
            referenceRange = new ArrayList<COCTMT120500UVReferenceRange2>();
        }
