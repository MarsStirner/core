...
public class TakenTissue implements Serializable {
    ...
    /**
     *0 - Ожидание
     *1 - Начато (медсестра взяла пробирки и иголки и пошла к пациентам)
     *2 - Закончено (медсестра закончила с пациентами; Гиппократ сообщает Ядру, что можно отправлять в ЛИС)
     *3 - Отправлено в ЛИС (устанавливается Ядром, если отправка прошла успешно)
     *4 - Ошибка отправки в ЛИС (устанавливается Ядром, если отправка провалилась)
     */
    @Basic(optional = false)
    @Column(name = "status")
