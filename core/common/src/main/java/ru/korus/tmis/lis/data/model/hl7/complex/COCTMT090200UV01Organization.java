...
/**
 * <p>Java class for COCT_MT090200UV01.Organization complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="COCT_MT090200UV01.Organization">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{urn:hl7-org:v3}InfrastructureRootElements"/>
 *         &lt;element name="name" type="{urn:hl7-org:v3}EN" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLicensedEntity" type="{urn:hl7-org:v3}COCT_MT090200UV01.LicensedEntity" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asMember" type="{urn:hl7-org:v3}COCT_MT090200UV01.Member" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asRoleOther" type="{urn:hl7-org:v3}COCT_MT090200UV01.RoleOther" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="asLocatedEntity" type="{urn:hl7-org:v3}COCT_MT070000UV01.LocatedEntity" minOccurs="0"/>
 *         &lt;element name="languageCommunication" type="{urn:hl7-org:v3}COCT_MT090200UV01.LanguageCommunication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "COCT_MT090200UV01.Organization", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "name",
...
public class COCTMT090200UV01Organization {
    ...
    protected List<COCTMT090200UV01LicensedEntity> asLicensedEntity;
    @XmlElement(nillable = true)
    protected List<COCTMT090200UV01Member> asMember;
    @XmlElement(nillable = true)
    protected List<COCTMT090200UV01RoleOther> asRoleOther;
    ...
    @XmlElement(nillable = true)
    protected List<COCTMT090200UV01LanguageCommunication> languageCommunication;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090200UV01LicensedEntity }
     * 
     * 
     */
    public List<COCTMT090200UV01LicensedEntity> getAsLicensedEntity() {
        if (asLicensedEntity == null) {
            asLicensedEntity = new ArrayList<COCTMT090200UV01LicensedEntity>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090200UV01Member }
     * 
     * 
     */
    public List<COCTMT090200UV01Member> getAsMember() {
        if (asMember == null) {
            asMember = new ArrayList<COCTMT090200UV01Member>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090200UV01RoleOther }
     * 
     * 
     */
    public List<COCTMT090200UV01RoleOther> getAsRoleOther() {
        if (asRoleOther == null) {
            asRoleOther = new ArrayList<COCTMT090200UV01RoleOther>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link COCTMT090200UV01LanguageCommunication }
     * 
     * 
     */
    public List<COCTMT090200UV01LanguageCommunication> getLanguageCommunication() {
        if (languageCommunication == null) {
            languageCommunication = new ArrayList<COCTMT090200UV01LanguageCommunication>();
        }
