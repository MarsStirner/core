...
#
# Параметры запуска скрипта: redeploy.sh <имя ear файла> <имя проекта (обычно имя еar без расширения)> <название домена>
...
GF_DOMAIN_NAME=$3                          
GF_DOMAIN_DIR=/opt/glassfish3/glassfish/domains
GF_ADMIN_PORT=4848                                   
GF_APP_NAME=$2
APP=$1
...
export PATH=/opt/glassfish3/bin/:$PATH
