...
/**
 * <p>
 * Java class for PatientCredentials complex type.
 * 
 * <p>
...
@XmlType(name = "PatientCredentials", namespace = "http://www.korusconsulting.ru", propOrder = { "id", "lastName", "firstName", "middleName", "birth",
        "bloodGroupId", "rhesusFactorId" })
public class PatientCredentials {
     ...
     * 
     */
    public void setBirth(final XMLGregorianCalendar value) {
        this.birth = value;
    }
