...
public interface DbStaffBeanLocal {
    ...
    java.util.HashMap<Staff, java.util.List<APValueTime>> getEmptyPersonsByRequest(int limit, int page, String sorting, ListDataFilter filter, int citoActionsCount)
            throws CoreException;
