...
public class DbQueueHsctRequestBean {
    ...
    public List<QueueHsctRequest> getAllActive() {
        return em.createNamedQuery("QueueHsctRequest.findAllByStatuses", QueueHsctRequest.class)
                .setParameter("statusList", EnumSet.of(Status.NEW, Status.ERROR,Status.IN_PROGRESS))
                .getResultList();
    }
}
