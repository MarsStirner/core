...
public interface DbRbFinanceBeanLocal {
     ...
     */
    java.util.LinkedList<Object> getAllRbFinanceWithFilter(int page, int limit, String sortingField, String sortingMethod, Object filter, Function1<Long, Boolean> setRecCount)
            throws CoreException;
}
