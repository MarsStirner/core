...
class DirectoryInfoRESTTest {
  ...
  def testGetActionTypesByGroupId = {
    ...
    val filter = new ActionTypesListRequestDataFilter("", 1, null, mnemonics, null)
    val request = new ListDataRequest("id", "asc", 10, 1, filter)
 ...
 @Test
  def testGetActionTypesByCode= {
    ...
    val mnemonics = new util.LinkedList[String]
    val filter = new ActionTypesListRequestDataFilter("testCode", 0, null, mnemonics, null)
    val request = new ListDataRequest("id", "asc", 10, 1, filter)
    val list = new util.LinkedList[ActionType]()
  ...
  def testGetActionTypesWithoutFilters = {
    ...
    val mnemonics = new util.LinkedList[String]
    val filter = new ActionTypesListRequestDataFilter("", 0, null, mnemonics, null)
    val request = new ListDataRequest("id", "asc", 10, 1, filter)
    val list = new util.LinkedList[ActionType]()
  ...
  def testGetActionTypesFlatView = {
    ...
    val mnemonics = new util.LinkedList[String]
    val filter = new ActionTypesListRequestDataFilter("", 1, null, mnemonics, "all")
    val request = new ListDataRequest("id", "asc", 10, 1, filter)
    val list = new util.LinkedList[ActionType]()
